...
describe("BatchRow", () => {
  it("renders metadata, sources, and actions", () => {
    render(
      <BatchRow batch={FIXTURE} isImporting={false} onImport={() => {}} />,
    );
  ...
  it("calls onImport with the batchId", () => {
    ...
    render(
      <BatchRow batch={FIXTURE} isImporting={false} onImport={onImport} />,
    );
  ...
  it("disables the button while importing", () => {
    render(<BatchRow batch={FIXTURE} isImporting={true} onImport={() => {}} />);
  ...
  it("collapses extra sources beyond the visible cap", () => {
    ...
    render(<BatchRow batch={many} isImporting={false} onImport={() => {}} />);
